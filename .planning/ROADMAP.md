...
- [x] **Phase 1: Fundação BeeWare e tela principal** — App Android em Python empacotado com BeeWare; uma tela Material; botões Ok/Sair; fonte open source incorporada e documentada. (completed 2026-05-13)
...
|-------|----------------|--------|-----------|
| 1. Fundação BeeWare e tela principal | 2/2 | Complete   | 2026-05-13 |
